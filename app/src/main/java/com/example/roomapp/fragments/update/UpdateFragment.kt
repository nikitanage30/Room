...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.update_age_txt.setText(args.currentUser.age.toString())
    ...
    private fun updateItem() {
        ...
        val age = Integer.parseInt(update_age_txt.text.toString())

        if (inputCheck(firstName, lastName, update_age_txt.text)) {
